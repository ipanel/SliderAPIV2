...
const (
	...
	// Gemini CLI OAuth credentials must be supplied by the deployment environment.
	// Deprecated empty values remain for source compatibility; no credential is embedded.
