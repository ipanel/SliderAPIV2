...
func TestBuildAuthorizationURL(t *testing.T) {
	...
	checks := []string{
		"response_type=code",
		"client_id=" + os.Getenv(GeminiCLIOAuthClientIDEnv),
		"redirect_uri=",
		"state=test-state",
...
func TestBuildAuthorizationURL_UsesBuiltinSecretFallback(t *testing.T) {
	...
	if !strings.Contains(authURL, "client_id="+os.Getenv(GeminiCLIOAuthClientIDEnv)) {
...
func TestEffectiveOAuthConfig_GoogleOne(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantClientID: os.Getenv(GeminiCLIOAuthClientIDEnv),
