...
func validIKIKRelease() *GitHubRelease {
	return &GitHubRelease{
		TagName: "v1.0.4",
		HTMLURL: "https://github.com/ipanel/SliderAPIv2/releases/tag/v1.0.4",
		Assets: []GitHubAsset{{
			Name:               "ikik-api_1.0.4_linux_amd64.tar.gz",
			BrowserDownloadURL: "https://github.com/ipanel/SliderAPIv2/releases/download/v1.0.4/ikik-api_1.0.4_linux_amd64.tar.gz",
		}},
	}
}
...
func TestValidateUpdateRepositoryURL(t *testing.T) {
	require.NoError(t, validateUpdateRepositoryURL("https://github.com/ipanel/SliderAPIv2/releases/download/v1.0.4/ikik-api_linux_amd64.tar.gz"))
	...
	require.Error(t, validateUpdateRepositoryURL("https://example.com/ipanel/SliderAPIv2/releases/download/v1.0.4/file.tar.gz"))
}
