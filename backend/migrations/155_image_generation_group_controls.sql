...
-- (migrated from COMMENT ON COLUMN) groups.allow_image_generation
-- (migrated from COMMENT ON COLUMN) groups.image_rate_independent
-- (migrated from COMMENT ON COLUMN) groups.image_rate_multiplier