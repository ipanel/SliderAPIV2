...
-- (migrated from COMMENT ON COLUMN) group_rate_schedules.target_user_id
-- (migrated from COMMENT ON TABLE) group_rate_schedule_user_states
-- (migrated from COMMENT ON COLUMN) group_rate_schedule_user_states.base_rate_multiplier