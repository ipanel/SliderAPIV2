...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "created_at", Type: field.TypeTime, Default: schema.Expr("CURRENT_TIMESTAMP"), SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "updated_at", Type: field.TypeTime, Default: schema.Expr("CURRENT_TIMESTAMP"), SchemaType: map[string]string{"postgres": "timestamptz"}},
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "credentials", Type: field.TypeJSON, Default: "{}", SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "extra", Type: field.TypeJSON, Default: "{}", SchemaType: map[string]string{"postgres": "jsonb"}},
