...
# ikik-api 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/ipanel/SliderAPIv2/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="ipanel/SliderAPIv2"
...
download_and_extract() {
    ...
    local archive_name="ikik-api-${OS}-${ARCH}.tar.gz"
